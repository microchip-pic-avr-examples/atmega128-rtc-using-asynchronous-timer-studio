...
pipeline {
	...
	environment {
		...
		GITHUB_URL ='https://github.com/microchip-pic-avr-examples/atmega128-rtc-using-asynchronous-timer-studio.git'
		BITBUCKET_URL = 'https://bitbucket.microchip.com/scm/ebe/atmega128-rtc-using-asynchronous-timer-studio.git'
